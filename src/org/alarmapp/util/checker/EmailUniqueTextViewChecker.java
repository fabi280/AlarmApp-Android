...
public class EmailUniqueTextViewChecker implements TextViewChecker {
	...
	public boolean isValid(TextView v) {
		try {
			...
			return AlarmApp.getWebClient()
					.checkEmailAdress(v.getText().toString()).wasSuccessful();
	...
	public String getFormatDescription() {
		if (!checkFailed)
			return "Es existiert bereits ein Benutzer mit dieser Email-Adresse.";
		return "Das Überprüfen des Benutzernamens ist fehlgeschlagen";
	}
